...
Complex besseli(const Complex& z, const double& nu) {
    //double zr = std::min(z.real(),700.0), zi = z.imag(), fnu = nu, cyr = 0.0, cyi = 0.0;
    double zr = z.real(), zi = z.imag(), fnu = nu, cyr = 0.0, cyi = 0.0;
    int kode = 2, n = 1, nz = 0, ierr = 0;
    Complex r;
    ...
    if (ierr > 1) {
        std::cout << "besseli error: " << ierr << " zr:" << zr << " nu:" << nu << std::endl;
    }
...
Complex besseli(const double& z, const double& nu) {
    //double zr = std::min(z, 700.0), zi = 0.0, fnu = nu, cyr = 0.0, cyi = 0.0;
    ...
    if (ierr > 1) {
        std::cout << "besseli error LOL: " << ierr << " zr:" << zr << " nu:" << nu << std::endl;
    }
